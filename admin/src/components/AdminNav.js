    ...
    return(
        <div className="h-screen w-1/3 border-r-2 border-black">
            <div className="container h-screen pt-10 text-lg tracking-widest Nav__content">
                ...
                <ul className="flex flex-col w-44 justify-around mx-auto text-xl space-y-5">
                ...
                <button className="h-24 static flex items-center justify-between border-t-2 border-black px-10 text-xl">
                    <div className="flex">
